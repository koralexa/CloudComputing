...
Образы запушены в Docker Hub, локальная сборка не требуется
...
По адресу <http://[api_url]:[api_port]/docs> можно найти интерактивную документацию api, позволяющую удобно выполнять запросы
